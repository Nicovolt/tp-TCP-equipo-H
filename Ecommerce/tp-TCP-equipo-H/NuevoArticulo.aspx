        ...
        <section class="contenedor">
            <div class="form-contenedor">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nombre del articulo">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Descripcion</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Descripcion del articulo">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Precio del articulo">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Stock</label>
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Cantidad de articulos">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Url de la imagen">
                </div>
            </div>
        </section>
